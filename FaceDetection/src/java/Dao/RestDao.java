...
public class RestDao {
    ...
    public modelo consultar(String url) throws IOException {
        modelo variablesModel = new modelo();
        ...
        try {
            ...
            request.addHeader("Ocp-Apim-Subscription-Key", "dabfc433793740ad9f94a3724cb7d644");
